...
${UPLOAD_SRC}
  ...
  function owRender(){
    ...
    var chg=document.getElementById("owChangeMode"); if(chg){ chg.hidden = !__owMode; chg.textContent = t("ow_change_mode"); }
  ...
  function renderBoard(data){
    ...
    [].forEach.call(root.querySelectorAll(".card[data-slug]"), function(c){
      ...
      var open=function(){ if(OPP_WINDOW) openOppWindow(slug); else openDrawer(slug); };
