...
(function(){
  ...
  var STR = {
    en: { title:"Thrive Board", sub:"Sign in to view the board.", email:"Operator email", pass:"Password",
          ...
          ow_campaign_upload:"Upload a campaign zip", ow_committed_n:"Campaign created. Cards: {n}", ow_no_msg_n:"{n} had no message and were not imported:",
    ...
    ar: { title:"لوحة ثرايف", sub:"سجّل الدخول لعرض اللوحة.", email:"بريد المشغّل", pass:"كلمة المرور",
          ...
          ow_campaign_upload:"ارفع ملف حملة مضغوط", ow_committed_n:"أُنشئت الحملة. البطاقات: {n}", ow_no_msg_n:"{n} بلا رسالة ولم تُستورَد:",
...
${UPLOAD_SRC}
  ...
  function owRender(){
    ...
    if(__owMode==="detail"){                                        // G4.5 detail-first: the drawer's detail/management half, in the window
      if(tabs){ tabs.hidden=true; tabs.innerHTML=""; }
      if(body){ body.innerHTML = '<div class="ow-detail" id="owDetail"></div>'; if(typeof owDetailMount==="function") owDetailMount(__owSlug); }
      return;
    }
